...
class PSPNet50(Network):
    def __init__(self, is_training=False, num_classes=150, input_size=[473, 473], style_color="111111110"):
        self.input_size = input_size
    ...
    def setup(self, is_training, num_classes):
        ...
        self.pred = decode_labels(raw_output_up, self.o_shape, num_classes, self.style_color)
